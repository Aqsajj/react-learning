...
const User = props => {
  return __jsx("div", {
    className: "jsx-1867361450"
  }, __jsx("h1", {
    className: "jsx-1867361450"
  }, " ", props.name), __jsx("p", {
    className: "jsx-1867361450"
  }, props.age), __jsx(style_default.a, {
    id: "1867361450"
  }, ["div.jsx-1867361450{border:1px solid blue;box-shadow:0 2p 3px #ccc;padding:20px;text-align:center;}"]));
};
...
const authIndexPage = props => {
  return auth_jsx("div", null, auth_jsx("h1", null, "The Auth Index Page of ", props.app), auth_jsx(components_User, {
    name: "Aqsa",
    age: "23"
  }));
};
