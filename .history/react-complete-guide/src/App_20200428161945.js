...
const App = (props) => {
  ...
  return (
    <div className="App">
      ...
      <button onClick={switchNameHandler.bind(this, 'Aqsajjj')}>Switch Name</button>
      <Person name={personState.persons[0].name} age={personState.persons[0].age} />
      <Person name={personState.persons[1].name} age={personState.persons[1].name} click={switchNameHandler.bind(this, 'jabeena')} >My Hobbies :Playing</Person>
